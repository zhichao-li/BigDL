...
class ActivationSpec extends KerasBaseSpec{
  ...
  "tanh" should "be the same as Keras" in {
    ...
    val layer = Activation[Float]("tanh", inputShape = Array(4, 5))
    seq.add(layer)
  ...
  "relu" should "be the same as Keras" in {
    val kerasCode =
      ...
      """.stripMargin
    val seq = Sequential[Float]()
    val layer = Activation[Float]("relu", inputShape = Array(4, 5))
    seq.add(layer)
    checkOutputAndGrad(seq.asInstanceOf[AbstractModule[Tensor[Float], Tensor[Float], Float]],
      kerasCode)
  }
  ...
  "sigmoid" should "be the same as Keras" in {
    val kerasCode =
      ...
      """.stripMargin
    val seq = Sequential[Float]()
    val layer = Activation[Float]("sigmoid", inputShape = Array(4, 5))
    seq.add(layer)
    checkOutputAndGrad(seq.asInstanceOf[AbstractModule[Tensor[Float], Tensor[Float], Float]],
      kerasCode)
  }
  ...
  "hard_sigmoid" should "be the same as Keras" in {
    val kerasCode =
      ...
      """.stripMargin
    val seq = Sequential[Float]()
    val layer = Activation[Float]("hard_sigmoid", inputShape = Array(4, 5))
    seq.add(layer)
    checkOutputAndGrad(seq.asInstanceOf[AbstractModule[Tensor[Float], Tensor[Float], Float]],
      kerasCode)
  }
  ...
  "softmax" should "be the same as Keras" in {
    val kerasCode =
      ...
      """.stripMargin
    val seq = Sequential[Float]()
    val layer = Activation[Float]("softmax", inputShape = Array(5))
    seq.add(layer)
    checkOutputAndGrad(seq.asInstanceOf[AbstractModule[Tensor[Float], Tensor[Float], Float]],
      kerasCode)
  }
  ...
  "softplus" should "be the same as Keras" in {
    val kerasCode =
      ...
      """.stripMargin
    val seq = Sequential[Float]()
    val layer = Activation[Float]("softplus", inputShape = Array(4, 5))
    seq.add(layer)
    checkOutputAndGrad(seq.asInstanceOf[AbstractModule[Tensor[Float], Tensor[Float], Float]],
      kerasCode)
  }
  ...
  "softsign" should "be the same as Keras" in {
    val kerasCode =
      ...
      """.stripMargin
    val seq = Sequential[Float]()
    val layer = Activation[Float]("softsign", inputShape = Array(4, 5))
    seq.add(layer)
    checkOutputAndGrad(seq.asInstanceOf[AbstractModule[Tensor[Float], Tensor[Float], Float]],
      kerasCode)
  }
