...
import com.intel.analytics.bigdl.utils.{RandomGenerator, TestUtils}
...
class SpatialMaxPoolingSpec extends FlatSpec with Matchers {
  ...
  "SpatialMaxPooling computeOutputShape NCHW" should "work properly" in {
    ...
    TestUtils.compareOutputShape(layer, Array(3, 12, 12)) should be (true)
  }
  ...
  "SpatialMaxPooling computeOutputShape NHWC" should "work properly" in {
    ...
    TestUtils.compareOutputShape(layer, Array(20, 20, 5)) should be (true)
  }
}
