...
@SerialVersionUID(- 6735223608686079388L)
class MaxPooling2D[T: ClassTag] (val poolSize: (Int, Int) = (2, 2),
                                 var strides: (Int, Int) = (2, 2),
...
object MaxPooling2D {
  def apply[@specialized(Float, Double) T: ClassTag](
    ...
    inputShape: Array[Int] = null)(implicit ev: TensorNumeric[T]) : MaxPooling2D[T] = {
