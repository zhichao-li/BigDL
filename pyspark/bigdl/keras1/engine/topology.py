...
class Tensor(object):
    ...
    def _shape(self):
        ...
        raise Exception("This keras tensor hasn't been initialized.")
...
class Layer(object):
    ...
    def __init__(self, **kwargs):
        ...
        if not name:
            ...
            name = prefix + '_' + bigdl_util.get_uid()
        self.name = name
    ...
    def call(self, x, mask=None):
        ...
        """
        return Tensor(self.B(bigdl_util.to_bigdl(x)), self)
...
class InputLayer(Layer):
    ...
    def __init__(self, input_shape=None, batch_input_shape=None,
        ...
        if input_tensor is None:
            # create an bigdl input here.
            from bigdl.keras1.engine.training import Model

            input_tensor = Tensor(bigdl_layer.Input(), self)
