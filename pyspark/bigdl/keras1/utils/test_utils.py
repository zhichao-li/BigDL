...
from bigdl.keras1.engine.topology import Input
from bigdl.keras1.engine.training import Model
from bigdl.keras1.engine.training import Sequential
...
def layer_test(layer_cls, kwargs={}, input_shape=None, input_dtype=float,
    ...
    # this testing is useless as weights is empty here as it hasn't been built.
